...
-- flip them using a little '\' function. We could have also used the
-- 'flip' function from last week's questions.
...
foldlFromFoldr f x xs = foldr (\a g b -> g (f b a)) (\b -> b) xs x
